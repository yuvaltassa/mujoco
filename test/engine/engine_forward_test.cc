...
TEST_F(ForwardTest, DiscreteFlexDisableFlags) {
  ...
  <mujoco>
    ...
    <worldbody>
      <flexcomp type="grid" count="4 4 1" spacing=".1 .1 .1" radius=".01" dim="2" mass="1" name="cloth">
        <contact selfcollide="none" contype="0" conaffinity="0"/>
        <elasticity young="1e4" poisson="0.3" thickness="1e-2" elastic2d="both" damping="0.05"/>
        <pin id="0"/>
      </flexcomp>
      <flexcomp type="grid" count="3 3 3" spacing=".1 .1 .1" radius=".01" dim="3" mass="1" name="solid" pos="1 0 0" dof="trilinear">
        <contact selfcollide="none" contype="0" conaffinity="0"/>
  ...
  <mujoco>
    ...
    <worldbody>
      ...
      <body name="parent" pos="1 0 0">
        ...
        <flexcomp type="grid" count="3 3 3" spacing=".1 .1 .1" radius=".01" dim="3" mass="1" name="solid" dof="trilinear">
          <contact selfcollide="none" contype="0" conaffinity="0"/>
          <elasticity young="1e4" poisson="0.3" damping="0.05"/>
        </flexcomp>
      </body>
